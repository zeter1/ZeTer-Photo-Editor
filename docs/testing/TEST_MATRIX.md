...
| Raster edit state / paint buffer / preview / persistence | `tests/painting-controller.test.mjs`, brush-performance, raster-save-boundary, architecture test | browser smoke when gesture/startup wiring changes |
