...
- PSD/PSB export preparation / bounds / group mapping / native high-depth-CMYK eligibility / merged composite → `document/psd-export-controller`; binary parse/write/rewrite → `formats/psd`
