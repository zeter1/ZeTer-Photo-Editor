...
- `src/adapters/psd.js` — изолированный PSD/PSB adapter: RGB 8/16-bit importer и RGB/8-bit writer, version-aware 32/64-bit lengths, импорт/экспорт слоёв, каналов, Unicode-имён и bitmap masks; writer кодирует RLE построчно и собирает крупные sections chunk-wise.
