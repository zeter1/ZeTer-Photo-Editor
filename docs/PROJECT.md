...
| Smart Object content lifecycle: convert/open/save/link/unlink, shared-source propagation, content-tab guards | `src/document/smart-object-controller.js`; Photoshop embedded-resource rewrite остаётся узким внешним port | `tests/smart-object-controller.test.mjs`, `tests/linked-smart-objects.test.mjs`, PSD Smart Object round-trip tests |
