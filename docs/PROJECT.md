...
- `src/adapters/psd.js` — изолированный RGB/8-bit PSD/PSB parser/writer: version-aware 32/64-bit lengths, импорт/экспорт слоёв, каналов, Unicode-имён и bitmap masks; writer кодирует RLE построчно и собирает крупные sections chunk-wise.
