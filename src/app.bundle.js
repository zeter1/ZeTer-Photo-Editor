...
function createLayersPanelController({ container, state = {}, actions = {}, ui = {} } = {}) {
...
function createColorManagementController({
  state = {},
  color = {},
  pixels = {},
  io = {},
...
function syncBlendingPreviewCanvas(preview, {
  documentValue,
  sourceCanvas,
  windowTarget = globalThis.window,
} = {}) {
...
function createLayerBlendingSession({
  owner,
  layer,
  getDocument = () => owner,
  markTransientChange = () => {},
...
function createLayerBlendingController({ state = {}, renderApi = {}, ui = {} } = {}) {
  const {
    getDocument = () => null,
    commit = () => {},
    markTransientChange = () => {},
...
function topVisibleTextLayerAt(documentValue, point) {
...
function createTextPreviewSession({
  owner,
  layer = null,
  point = null,
  getDocument = () => owner,
...
function syncTextPreviewCanvas(draft, {
  documentValue,
  sourceCanvas,
  zoom = 1,
  windowTarget = globalThis.window,
...
function createTextEditController({ state = {}, text = {}, renderApi = {}, ui = {} } = {}) {
  const {
    getDocument = () => null,
    getSelectedLayer = () => null,
    selectLayer = () => {},
...
function createSelectionMaskController({
  state = {},
  selection = {},
  rendering = {},
  ui = {},
...
function createSelectionVectorMaskController({
  state = {},
  selection = {},
  geometry = {},
  edit = {},
 ...
 */
function createPsdExportController({
 ...
 */
function createPsdSmartObjectResource({
  prepareDocument,
  opaqueBlockToState,
} = {}) {
